...
import StockAvailabilityUnified from "./stockAvailability/StockAvailabilityUnified";
...
const ScaleDataDisplay = ({ order }: {
    ...
    console.log("ScaleDataDisplay - weightKg:", weightKg);
    console.log("ScaleDataDisplay - unitsCount:", unitsCount);
