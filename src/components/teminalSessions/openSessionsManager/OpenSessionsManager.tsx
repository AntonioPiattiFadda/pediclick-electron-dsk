...
const OpenSessionsManager = ({ open, onOpenChange }: OpenSessionsManagerProps) => {
    ...
    const closeMutation = useMutation({
        ...
        onSuccess: () => {
            ...
            toast.success("La sesión se cerró exitosamente.");
    ...
    const closeAllMutation = useMutation({
        ...
        onSuccess: () => {
            queryClient.invalidateQueries({ queryKey: ["openTerminalSessions"] });
            toast.success("Todas las sesiones se cerraron exitosamente.");
            setShowCloseAllConfirm(false);
        },
        onError: (error) => {
            toast.error("No se pudieron cerrar todas las sesiones. Intente nuevamente.");
